...
<?php
  $sql = $koneksi->query("SELECT SUM(masuk) as tot_masuk  from dana_sosial where jenis='Masuk' and tgl_ds BETWEEN '$dt1' AND '$dt2'");
...
<html lang="en">
<head>
   <title>Laporan Pemasukan Kas Sosial</title>
</head>
<body>
<center>
