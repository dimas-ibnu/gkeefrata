		...
		<div class="table-responsive">
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<?php
              $no = 1;
              $sql = $koneksi->query("select * from perpuluhan where jenis='Masuk' order by tgl_pul desc");
              while ($data= $sql->fetch_assoc()) {
            ?>
					...
					<tr>
						...
						<td>
							...
							<a href="?page=i_del_pil&kode=<?php echo $data['id_pul']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')"
