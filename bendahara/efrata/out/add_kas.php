	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" id="uraian_kas" name="uraian_kas" placeholder="Uraian Pengeluaran" required>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-4">
					<input type="date" class="form-control" id="tgl_kas" name="tgl_kas" required>
				</div>
			</div>
...
<?php
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO dana_kas (tgl_kas,uraian_kas,masuk,keluar,jenis) VALUES (
        '".$_POST['tgl_kas']."',
        '".$_POST['uraian_kas']."',
        '0',
        '".$keluar_hasil."',
